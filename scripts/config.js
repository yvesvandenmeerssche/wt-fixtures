...
module.exports = {
  ...
  // See https://github.com/windingtree/wt-write-api#uploaders for documentation
  UPLOADERS: {
    "root": {
      "swarm": {}
    }
  ...
  WT_NOTIFICATION_API: "http://localhost:8080/", // Optional - set to publish notifications there.
};
